export default function Hero() {
  return (
    <section className="flex flex-col items-center justify-center text-center gap-6 lg:gap-5 mt-12 lg:mt-52  px-6">
      <div>
        <span className="font-body font-normal  text-[16px]  lg:tracking-[4px] text-white">
          Welcome to Solve.
        </span>
      </div>
      <div>
        <h1 className="font-body font-semibold text-[clamp(30px,5vw,50px)] tracking-wide leading-[1.2]">
          Manage Your Task
          <br />
          Efficiently
        </h1>
      </div>
      <p className="font-body text-[clamp(14px,1.1vw,15px)] text-white">
